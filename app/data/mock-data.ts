...
export const mockMessages: NylasMessageWithContact[] = [
  // Today's messages for testing "Today" separator
  {
    starred: false,
    unread: false,
    folders: ["INBOX"],
    ...
    thread_id: "thread_2",
    body: "<p>Good morning everyone!</p><p>Just wanted to start the day with some positive news - our latest feature release is performing really well. User engagement is up 15% this week!</p><p>Let's keep up the great work!</p>",
    grant_id: "grant_123",
    id: "msg_today_1",
    object: "message",
    snippet: "Good morning everyone! Just wanted to start the day with some positive news...",
    bcc: [],
    cc: [],
    attachments: [],
    ...
    date: Math.floor(new Date().setHours(9, 0, 0, 0) / 1000), // Today at 9:00 AM
    derivedContact: {
  ...
  },
  {
    ...
    unread: true,
    folders: ["INBOX"],
    subject: "Re: Good morning team!",
    thread_id: "thread_2",
    body: "<p>Thanks Jane! That's fantastic news.</p><p>I'm excited to see the numbers continue to grow. The team has been working really hard on this.</p>",
    grant_id: "grant_123",
    id: "msg_today_2",
    object: "message",
    snippet: "Thanks Jane! That's fantastic news...",
    bcc: [],
    cc: [],
    attachments: [],
    from: [{ email: "user@company.com" }],
    reply_to: [{ email: "user@company.com" }],
    to: [{ email: "jane.smith@example.com" }],
    date: Math.floor(new Date().setHours(9, 15, 0, 0) / 1000), // Today at 9:15 AM
    derivedContact: {
      email: "jane.smith@example.com",
      derivedName: "Jane Smith",
      nylasContact: mockNylasContacts[1],
  ...
  //   subject: "Good morning team!",
  //   thread_id: "thread_2",
  //   body: "<p>Absolutely! The hard work is definitely paying off. 🎉</p>",
  //   grant_id: "grant_123",
  //   id: "msg_today_reply_1",
  //   object: "message",
  //   snippet: "Absolutely! The hard work is definitely paying off. 🎉",
  //   bcc: [],
  //   cc: [],
  //   attachments: [],
  ...
  //   to: [{ email: "jane.smith@example.com" }],
  //   date: Math.floor(new Date().setHours(9, 20, 0, 0) / 1000), // Today at 9:20 AM
  //   replyToMessageId: "msg_today_1", // This is a reply to Jane's good morning message
  //   derivedContact: {
  ...
  // },
  {
    ...
    thread_id: "thread_today_2",
    body: "<p>Hi!</p><p>Just a quick reminder about our lunch meeting today at 1 PM. I've made a reservation at the downtown bistro.</p><p>Looking forward to discussing the Q4 strategy!</p>",
    grant_id: "grant_123",
    id: "msg_today_3",
    object: "message",
    snippet: "Just a quick reminder about our lunch meeting today at 1 PM...",
    bcc: [],
    cc: [],
    attachments: [],
    from: [{ email: "mike.wilson@acme.com" }],
    reply_to: [{ email: "mike.wilson@acme.com" }],
    to: [{ email: "user@company.com" }],
    date: Math.floor(new Date().setHours(11, 30, 0, 0) / 1000), // Today at 11:30 AM
    derivedContact: {
      email: "mike.wilson@acme.com",
      derivedName: "Mike Wilson",
      nylasContact: mockNylasContacts[2],
  ...
  // Add a reply to the lunch meeting
  {
    starred: false,
    unread: false,
    folders: ["INBOX"],
    subject: "Lunch meeting reminder",
    thread_id: "thread_today_2",
    body: "<p>Perfect! See you there at 1 PM. Thanks for making the reservation!</p>",
    grant_id: "grant_123",
    id: "msg_today_reply_2",
    object: "message",
    snippet: "Perfect! See you there at 1 PM. Thanks for making the reservation!",
    bcc: [],
    cc: [],
    attachments: [],
    from: [{ email: "user@company.com" }],
    reply_to: [{ email: "user@company.com" }],
    to: [{ email: "mike.wilson@acme.com" }],
    date: Math.floor(new Date().setHours(11, 35, 0, 0) / 1000), // Today at 11:35 AM
    replyToMessageId: "msg_today_3", // This is a reply to Mike's lunch reminder
    derivedContact: {
      email: "mike.wilson@acme.com",
      derivedName: "Mike Wilson",
      nylasContact: mockNylasContacts[2],
  ...
  },
  {
    ...
    to: [{ email: "user@company.com" }],
    date: Math.floor(new Date().setDate(new Date().getDate() - 1) / 1000), // Yesterday
    derivedContact: {
...
export const mockThreads: ForumThreadWithContact[] = [
  {
    ...
    latest_draft_or_message: {
      ...
      reply_to: [{ email: "user@company.com" }],
      to: [{ email: "john.doe@example.com" }],
      date: Math.floor(new Date().setHours(9, 0, 0, 0) / 1000),
    },
  ...
  },
  {
    ...
    latest_draft_or_message: {
      ...
      subject: "Re: Good morning team!",
      thread_id: "thread_2",
      body: "<p>Thanks Jane! That's fantastic news.</p>",
      grant_id: "grant_123",
      id: "msg_today_2",
      object: "message",
      snippet: "Thanks Jane! That's fantastic news...",
      ...
      reply_to: [{ email: "user@company.com" }],
      to: [{ email: "jane.smith@example.com" }],
      date: Math.floor(new Date().setHours(9, 15, 0, 0) / 1000),
    },
    has_attachments: false,
    has_drafts: false,
    grant_id: "grant_123",
    ...
    message_ids: ["msg_today_1", "msg_today_2", "msg_today_reply_1", "msg_3"],
    draft_ids: [],
    earliest_message_date: Date.now() - 7200000,
    latest_message_received_date: Math.floor(new Date().setHours(9, 15, 0, 0) / 1000),
    derivedContact: {
      name: "Jane Smith",
      email: "jane.smith@example.com",
      nylasContact: mockNylasContacts[1],
  ...
  },
  {
    ...
    latest_draft_or_message: {
      ...
      reply_to: [{ email: "user@company.com" }],
      to: [{ email: "mike.wilson@acme.com" }],
      date: Math.floor(new Date().setHours(11, 35, 0, 0) / 1000),
    },
    has_attachments: false,
    has_drafts: false,
    grant_id: "grant_123",
    ...
    message_ids: ["msg_today_3", "msg_today_reply_2"],
    draft_ids: [],
    earliest_message_date: Math.floor(new Date().setHours(11, 30, 0, 0) / 1000),
    latest_message_received_date: Math.floor(new Date().setHours(11, 35, 0, 0) / 1000),
    derivedContact: {
      name: "Mike Wilson",
      email: "mike.wilson@acme.com",
      nylasContact: mockNylasContacts[2],
